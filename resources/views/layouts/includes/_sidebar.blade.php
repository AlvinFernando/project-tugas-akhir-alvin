      ...
      <div class="sidebar-scroll">
            <nav>
                  <ul class="nav" style="margin-top: 100px;">
                        <li><a href="{{ url('/dashboards') }}" class=""><i class="fa fa-tachometer-alt"></i> <span>Dashboard</span></a></li>
                        @if (Auth::user()->level == 'admin' || Auth::user()->level == 'kepsek')
                              ...
                              <li class="dropdown">
                                    <a href="#subPages2" data-toggle="collapse" class="collapsed"><i class="fas fa-clipboard"></i> <span>&nbsp;Manajemen Data</span> <i class="icon-submenu lnr lnr-chevron-left float-right"></i></a>
